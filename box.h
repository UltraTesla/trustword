...
#	define HASH32_SIZE     32
#	define HASH32_SIZE_HEX (HASH32_SIZE*2)
...
#	define VERIFYKEY_SIZE_BIN    (crypto_sign_PUBLICKEYBYTES+1)
...
#	define PUBLICKEY_SIZE_BIN_ID_MAC (PUBLICKEY_SIZE_BIN_ID + crypto_secretbox_MACBYTES + crypto_secretbox_NONCEBYTES)
#	define SECRETKEY_SIZE_BIN_ID_MAC (SECRETKEY_SIZE_BIN_ID + crypto_secretbox_MACBYTES + crypto_secretbox_NONCEBYTES)
#	define VERIFYKEY_SIZE_BIN_ID_MAC (VERIFYKEY_SIZE_BIN_ID + crypto_secretbox_MACBYTES + crypto_secretbox_NONCEBYTES)
#	define SIGNKEY_SIZE_BIN_ID_MAC   (SIGNKEY_SIZE_BIN_ID   + crypto_secretbox_MACBYTES + crypto_secretbox_NONCEBYTES)

#	define PUBLICKEY_SIZE_HEX_ID_MAC (PUBLICKEY_SIZE_BIN_ID_MAC*2)
#	define SECRETKEY_SIZE_HEX_ID_MAC (SECRETKEY_SIZE_BIN_ID_MAC*2)
#	define VERIFYKEY_SIZE_HEX_ID_MAC (VERIFYKEY_SIZE_BIN_ID_MAC*2)
#	define SIGNKEY_SIZE_HEX_ID_MAC   (SIGNKEY_SIZE_BIN_ID_MAC*2)
